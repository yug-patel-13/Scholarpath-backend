...
var AdminService = function () {
    ...
    var AdminService = _classThis = /** @class */ (function () {
        function AdminService_1(formFillRequestRepository, userRepository, scholarshipRepository, categoryRepository, cyberCafeRepository) {
        ...
        AdminService_1.prototype.getDashboardStats = function () {
            return __awaiter(this, void 0, void 0, function () {
                var _a, totalRequests, pendingRequests, completedRequests, totalUsers, totalScholarships, totalCategories;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _a = _b.sent(), totalRequests = _a[0], pendingRequests = _a[1], completedRequests = _a[2], totalUsers = _a[3], totalScholarships = _a[4], totalCategories = _a[5];
                            return [2 /*return*/, {
        ...
        AdminService_1.prototype.getAllRequests = function () {
            return __awaiter(this, void 0, void 0, function () {
        ...
        AdminService_1.prototype.updateRequestStatus = function (id, status, adminNotes) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.formFillRequestRepository.update(id, { status: status, adminNotes: adminNotes })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, this.formFillRequestRepository.findOne({ where: { id: id }, relations: ['user'] })];
                    }
                });
            });
        };
