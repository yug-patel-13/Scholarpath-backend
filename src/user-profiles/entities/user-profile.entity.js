...
var UserProfile = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('user_profiles')];
    ...
    var UserProfile = _classThis = /** @class */ (function () {
        function UserProfile_1() {
            ...
            this.category = (__runInitializers(this, _user_extraInitializers), __runInitializers(this, _category_initializers, void 0)); // farmer, sc/st/obc, merit, woman, ews
            ...
            this.caste = (__runInitializers(this, _gender_extraInitializers), __runInitializers(this, _caste_initializers, void 0)); // general, sc, st, obc, ebc
            ...
            // Farmer-specific
            this.landSize = (__runInitializers(this, _marks12_extraInitializers), __runInitializers(this, _landSize_initializers, void 0)); // in acres
            this.crop = (__runInitializers(this, _landSize_extraInitializers), __runInitializers(this, _crop_initializers, void 0));
            this.farmerType = (__runInitializers(this, _crop_extraInitializers), __runInitializers(this, _farmerType_initializers, void 0)); // marginal, small, large
            this.loanStatus = (__runInitializers(this, _farmerType_extraInitializers), __runInitializers(this, _loanStatus_initializers, void 0)); // yes, no
            // Location
    ...
    __setFunctionName(_classThis, "UserProfile");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)()];
        _userId_decorators = [(0, typeorm_1.Column)({ unique: true })];
        _user_decorators = [(0, typeorm_1.OneToOne)(function () { return user_entity_1.User; }, function (user) { return user.profile; }), (0, typeorm_1.JoinColumn)({ name: 'userId' })];
        _category_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _name_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _age_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _gender_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _caste_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _aadhaar_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _phone_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _annualIncome_decorators = [(0, typeorm_1.Column)('decimal', { precision: 10, scale: 2, nullable: true })];
        _marks10_decorators = [(0, typeorm_1.Column)('decimal', { precision: 5, scale: 2, nullable: true })];
        _marks12_decorators = [(0, typeorm_1.Column)('decimal', { precision: 5, scale: 2, nullable: true })];
        _landSize_decorators = [(0, typeorm_1.Column)('decimal', { precision: 10, scale: 2, nullable: true })];
        _crop_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _farmerType_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _loanStatus_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        ...
        _documents_decorators = [(0, typeorm_1.Column)('jsonb', { nullable: true })];
