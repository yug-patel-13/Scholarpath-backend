...
var form_fill_requests_service_1 = require("./form-fill-requests.service");
var form_fill_requests_controller_1 = require("./form-fill-requests.controller");
var form_fill_request_entity_1 = require("./entities/form-fill-request.entity");
var FormFillRequestsModule = function () {
    ...
    var _classThis;
    var FormFillRequestsModule = _classThis = /** @class */ (function () {
        function FormFillRequestsModule_1() {
        }
        return FormFillRequestsModule_1;
    }());
    __setFunctionName(_classThis, "FormFillRequestsModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        FormFillRequestsModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FormFillRequestsModule = _classThis;
}();
